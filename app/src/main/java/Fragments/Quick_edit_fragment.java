 ...
 */
public class Quick_edit_fragment extends Fragment implements Quick_edit_Apapter.Ondeleteonclick {
...
//                                for (int i = 0; i < commoditylist.size(); i++) {
//                                    if (commoditylist.get(i).getPosition() != 0&&commoditylist.size()>=commoditylist.get(i).getPosition()) {
//                                        adats.set((commoditylist.get(i).getPosition() - 1), commoditylist.get(i));
//                                    }
//                                }
                                SortUtils.sort7(adats);
