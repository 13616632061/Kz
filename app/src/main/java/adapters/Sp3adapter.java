 ...
 */
public class Sp3adapter extends BaseAdapter {
    public Context context;
    public List<String> adats;

    public Sp3adapter(Context context) {
        this.context = context;
        this.adats=new ArrayList<>();
    }

    public void setAdats(List<String> adats){
        this.adats=adats;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view!=null){
            ...
            viewHored.tv_name.setText(adats.get(i));
        return view;
    }
