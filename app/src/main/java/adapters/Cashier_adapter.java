 ...
 */
public class Cashier_adapter extends BaseAdapter {
    public Context context;
    public List<Cashier_entty> adats;

    public Cashier_adapter(Context context) {
        this.context = context;
        this.adats=new ArrayList<>();
    }

    public void setAdats(List<Cashier_entty> adats){
        this.adats=adats;
